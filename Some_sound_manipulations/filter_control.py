...
for i,bp_signal in enumerate(s0_bp):
    ...
    envelopes.append(butter_bandpass_filter(np.abs(analytic_signal),0,50,samp_freq,2))
...
wavfile.write('filter_control_'+filename,samp_freq,control_snd)
wavfile.write('filter_rebuild_'+filename,samp_freq,rebuild_snd)
